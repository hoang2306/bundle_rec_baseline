        ...
        for batch_i, batch in pbar:
            ...
            if (batch_anchor+1) % test_interval_bs == 0:  
                ...
                best_metrics, best_perform, best_epoch = log_metrics(
                    conf, model, metrics, log_path, checkpoint_model_path, 
                    checkpoint_conf_path, epoch, batch_anchor, best_metrics, 
                    best_perform, best_epoch, user_test_list, bundle_test_list, score_test_list
                )
...
def log_metrics(conf, model, metrics, log_path, checkpoint_model_path, checkpoint_conf_path, epoch, batch_anchor, best_metrics, best_perform, best_epoch, user_list, bundle_list, score_list):
    for topk in conf["topk"]:
